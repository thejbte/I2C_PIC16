...
void I2C_Initialize(void){
    ...
    SSPCON1 = 0B00101000 ;
    SSPADD = (unsigned char)((16000000/4000/100)-1);
...
void I2C_Wait1(void){
    ...
    while( (SSPSTAT & 0x04) || (SSPCON2 & 0b00011111)) ;
}
void I2C_Wait2(void){
...
void Wrappers_I2CMaster_Write(uint8_t Address7b, void * data, uint8_t amount){
    ...
    I2C_Start ();
    I2C_Write (Address7b<<1);
    I2C_Write (DatatoSend[0]);
    I2C_Write (DatatoSend[1]);
    I2C_Stop ();
}
...
uint8_t *DatatoSend = (uint8_t *)Register;
    ...
    I2C_Write (Address7b<<1);
     ...
     I2C_Write (*DatatoSend);

     I2C_RStart();
     I2C_Write (Address7b<<1|0x01);


    *DatatoSend = I2C_Read (1);
    I2C_Stop ();
}
